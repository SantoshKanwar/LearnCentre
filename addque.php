          ...
          <div class="wrapper"> 
            ...
            <div class="grid9"> <section class="images"> 
              <table width="80%" align="right" height="50%">
                <tr> 
                  <td colspan="2"> <div2>ADD Question </div2></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td><div10> 
                    <textarea name="que" cols="22" rows="3"></textarea>
                    </div10></td>
                </tr>
                <tr> 
                  <td> <div10>Ans1</div10></td>
                  <td><div10> 
                    <input name="ans1" type="text" size="20">
                    </div10></td>
                </tr>
                <tr> 
                  <td> <div10>Ans2</div10></td>
                  <td><div10> 
                    <input name="ans2" type="text" size="20">
                    </div10></td>
                </tr>
                <tr> 
                  <td> <div10>Ans3</div10></td>
                  <td><div10> 
                    <input name="ans3" type="text" size="20">
                    </div10></td>
                </tr>
                <tr> 
                  <td> <div10>Ans4</div10></td>
                  <td><div10> 
                    <input name="ans4" type="text" size="20">
                    </div10></td>
                </tr>
                <tr> 
                  <td> <div10>Correct Ans</div10></td>
                  <td><div10> 
                    <input name="cans" type="text" size="20">
                    </div10></td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
